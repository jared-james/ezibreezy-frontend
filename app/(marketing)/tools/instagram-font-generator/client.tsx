      ...
      <div className="max-w-6xl mx-auto space-y-12 relative z-10">
        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <p className="font-serif text-xl md:text-2xl text-foreground/80 max-w-2xl leading-relaxed italic border-l-2 border-dotted border-brand-primary pl-6">
            Style your Bio. Stand out in comments. Generate aesthetic typography
            to copy & paste into Instagram.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-12 gap-12 pt-16 border-t-4 border-double border-foreground">
          <div className="md:col-span-7 space-y-8">
            ...
            <div className="space-y-6 text-lg font-serif leading-relaxed text-foreground/80">
              ...
              <p>
                By strategically using <strong>bold</strong> or <em>italic</em>{" "}
                Unicode characters, you can create visual hierarchy within your
                bio.
              </p>
              ...
              <ul className="space-y-3 mt-4">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Highlight Keywords:</strong> Use bold font for your
                    title or niche (e.g., <strong>Photographer</strong>) to make
                    it skimmable.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    these characters. Don&apos;t put critical information solely
                    in fancy fonts.
                  </span>
                </li>
              </ul>
          ...
          <div className="md:col-span-5 flex flex-col justify-end">
            <div className="border-l-2 border-t-2 border-foreground p-8 bg-surface shadow-sm">
              ...
              <p className="text-muted-foreground mb-6 text-sm leading-relaxed">
                ...
                entire feed, split panoramas into carousels, and schedule posts
                for maximum reach.
              </p>
              <a
                href="/auth/signup"
