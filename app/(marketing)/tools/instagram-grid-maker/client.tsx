// app/(marketing)/tools/instagram-grid-maker/client.tsx

"use client";

import { useState } from "react";
import { Loader2, Trash2, Scissors } from "lucide-react";
import { processAndDownload } from "@/lib/tools/image-processing";
      ...
      <div className="max-w-6xl mx-auto space-y-12 relative z-10">
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <p className="font-serif text-xl md:text-2xl text-foreground/80 max-w-2xl leading-relaxed italic border-l-2 border-dotted border-brand-primary pl-6">
            Split any photo into a 3x3, 2x3, or custom grid for your profile.
            Includes gap compensation for perfect alignment.
          </p>
        </div>
