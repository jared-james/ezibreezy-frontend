...
import { Scissors, Type, Crop } from "lucide-react";
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/70 leading-relaxed">
                    Add emphasis to your professional updates. Generate{" "}
                    <strong>bold</strong> & <em>italic</em> text for headers.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/70 leading-relaxed">
                    Don't get cropped out. Resize your images specifically for
                    the LinkedIn feed (1.91:1).
                  </p>
                </div>
              </div>
            </Link>
