// app/(marketing)/features/linkedin-scheduler/inbox.tsx
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        <div className="md:col-span-7 order-1 md:order-2">
          ...
          <div className="prose prose-lg font-serif text-foreground/80 leading-relaxed">
            <p>
              Publishing is just the invitation. The real connection happens
              when you respond.
            </p>
            <p>
              Our <strong>Unified Inbox</strong> brings every comment into one
