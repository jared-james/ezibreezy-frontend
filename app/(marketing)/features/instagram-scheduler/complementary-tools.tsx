// app/(marketing)/features/instagram-scheduler/complementary-tools.tsx

import Link from "next/link";
import { Scissors, Type, Layout, Grid } from "lucide-react";
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/70 leading-relaxed">
                    Style your bio and captions with intention. Generate bold,
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/70 leading-relaxed">
                    Turn panoramas into seamless swipeable stories. Split one
                    image into three perfectly.
                  </p>
                </div>
              </div>
            </Link>
