// app/(marketing)/features/threads-scheduler/complementary-tools.tsx

import Link from "next/link";
import { Scissors, GalleryHorizontal, Type } from "lucide-react";
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/70 leading-relaxed">
                    Create seamless panoramic swipes. Split wide images into
                    perfect 1080x1350 segments.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/70 leading-relaxed">
                    Add emphasis to your threads. Generate <strong>bold</strong>{" "}
                    or <em>italic</em> unicode text.
                  </p>
                </div>
              </div>
            </Link>
