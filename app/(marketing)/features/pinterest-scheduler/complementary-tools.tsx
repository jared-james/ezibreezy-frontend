// app/(marketing)/features/pinterest-scheduler/complementary-tools.tsx
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/70 leading-relaxed">
                    Crop perfectly for Pinterest (2:3). Ensure your vertical
                    visuals aren't cut off in the feed.
                  </p>
                </div>
              </div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground/70 leading-relaxed">
                    Turn browser screenshots into aesthetic Pin graphics
                    instantly. Add backgrounds and shadows.
                  </p>
                </div>
              </div>
            </Link>
