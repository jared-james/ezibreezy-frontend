...
export default function MediaPanel({
  ...
  const mediaFile = externalMediaFile !== undefined ? externalMediaFile : internalMediaFile;
  const mediaPreview = externalMediaPreview !== undefined ? externalMediaPreview : internalMediaPreview;
      ...
      <div className="bg-[--surface] border border-[--border] p-5 mt-4">
        {!mediaPreview ? (
          ...
          <div className="relative aspect-square bg-[--background] border border-[--border]">
            ...
            <button
              onClick={removeMedia}
              className="absolute top-2 right-2 bg-[--foreground] text-[--background] p-1.5 hover:bg-[--muted] transition-colors"
