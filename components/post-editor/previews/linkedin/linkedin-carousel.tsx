// components/post-editor/previews/linkedin/linkedin-carousel.tsx
...
export function LinkedInCarousel({
  ...
  // Use cropped preview for LinkedIn if available, otherwise use mediaUrl for video or preview
  const displayMediaSrc =
    currentMedia?.croppedPreviews?.linkedin ||
